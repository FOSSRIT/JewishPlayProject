	...
	for(var i = 0; i < editButtons.length; i++)
	{
		editButtons[i].onclick = function(e)
		{
            ...
            else
            {
                ...
                {
                    companiesCell += "<div id='inputCompaniesContainer_" + row + "_" + j + "' row=" + row + " index='" + j + "'><input type='text' class='inputCompanies__" + row + "' id='inputCompanies_" + row + "_" + j + "' row=" + row + " index='" + j + "' value='" + (g_data[row].Companies[j] == null ? "" : g_data[row].Companies[j]) + "'></input>";
                    if(j > 0)
                    {
            ...
            else
            {
                ...
                {
                    toysCell += "<div id='inputToysContainer_" + row + "_" + j + "' row=" + row + " index='" + j + "'><input type='text' class='inputToys__" + row + "' id='inputToys_" + row + "_" + j + "' row=" + row + " index='" + j + "' value='" + (g_data[row].Toys[j] == null ? "" : g_data[row].Toys[j]) + "'></input>";
                    if(j > 0)
                    {
            ...
            else
            {
                ...
                {
                    sourcesCell += "<div id='inputSourcesContainer_" + row + "_" + j + "' row=" + row + " index='" + j + "'><input type='text' class='inputSources__" + row + "' id='inputSources_" + row + "_" + j + "' row=" + row + " index='" + j + "' value='" + (g_data[row].Sources[j] == null ? "" : g_data[row].Sources[j]) + "'></input>";
                    if(j > 0)
                    {
            ...
            else
            {
                ...
                {
                    sourceTitlesCell += "<div id='inputSourceTitlesContainer_" + row + "_" + j + "' row=" + row + " index='" + j + "'><input type='text' class='inputSourceTitles__" + row + "' id='inputSourceTitles_" + row + "_" + j + "' row=" + row + " index='" + j + "' value='" + (g_data[row].SourceTitles[j] == null ? "" : g_data[row].SourceTitles[j]) + "'></input>";
                    if(j > 0)
                    {
			...
			document.getElementById("firstName_" + row).innerHTML = "<input type='text' id='inputFirstName_" + row + "' value='" + (g_data[row].FirstName == null ? "" : g_data[row].FirstName) + "'></input>";
			document.getElementById("middleName_" + row).innerHTML = "<input type='text' id='inputMiddleName_" + row + "' value='" + (g_data[row].MiddleName == null ? "" : g_data[row].MiddleName) + "'></input>";
			document.getElementById("lastName_" + row).innerHTML = "<input type='text' id='inputLastName_" + row + "' value='" + (g_data[row].LastName == null ? "" : g_data[row].LastName) + "'></input>";
			document.getElementById("birthYear_" + row).innerHTML = "<input type='text' id='inputBirthYear_" + row + "' value='" + (g_data[row].BirthYear == null ? "" : g_data[row].BirthYear) + "'></input>";
			document.getElementById("deathYear_" + row).innerHTML = "<input type='text' id='inputDeathYear_" + row + "' value='" + (g_data[row].DeathYear == null ? "" : g_data[row].DeathYear) + "'></input>";
			...
			document.getElementById("bio_" + row).innerHTML = "<input type='text' id='inputBio_" + row + "' value='" + (g_data[row].Bio == null ? "" : g_data[row].Bio) + "'></input>";
			document.getElementById("picture_" + row).innerHTML = "<input type='text' id='inputPicture_" + row + "' value='" + (g_data[row].Picture == null ? "" : g_data[row].Picture) + "'></input>";
